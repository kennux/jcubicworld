package net.kennux.cubicworld.voxel.generator.noise;
...
{ // Simplex noise in 2D, 3D and 4D
	...
	{
		int[] swapIndices = new int[p.length];

		for (int i = 0; i < p.length; i++)
		{
			int random = (int) (((float) Math.random()) * p.length);

			// Random already in list?
