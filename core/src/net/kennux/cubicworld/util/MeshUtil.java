...
public class MeshUtil
{
	...
	public static Mesh buildBlockMesh(int topTexture, int bottomTexture, int leftTexture, int rightTexture, int frontTexture, int backTexture)
	{
		...
		Vector2[][] uvsArray = new Vector2[][]
		{
			VoxelEngine.getUvForTexture(leftTexture),
			VoxelEngine.getUvForTexture(rightTexture),
			VoxelEngine.getUvForTexture(topTexture),
			VoxelEngine.getUvForTexture(bottomTexture),
			VoxelEngine.getUvForTexture(backTexture),
			VoxelEngine.getUvForTexture(frontTexture)
		};
